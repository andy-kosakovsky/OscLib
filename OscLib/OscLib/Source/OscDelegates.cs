...
namespace OscLib
{
    ...
    public delegate bool OscPacketReadyChecker<Packet>(Packet packet) where Packet : IOscPacketBinary;
    ...
    public delegate bool OscPacketRemover<Packet>(Packet packet) where Packet : IOscPacketBinary;
